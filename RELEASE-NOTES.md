...
Repository release **v1.1.1** packages firmware and companion Python tools **V1.1**. Analytical-tuning filenames and commands use the spelling **Analytical** consistently.
