...
The upstream software identifies its licence as **BSD** in the notices reproduced above. Preserve these notices, together with any additional licence text accompanying the incorporated source version. The MIT licence for original TSRCT contributions does not replace the upstream terms.
